# PLANNING_FULL_AUTOMATION_CONTRACT
...
| home-shot | TEXT_EDITOR | capture |  |  | NOT_APPLICABLE |  |
...
| date-shot | DATE_PICKER | capture |  |  | NOT_APPLICABLE |  |
...
| fixture | TEXT_EDITOR | fixture |  |  | NOT_APPLICABLE |  |
| import-page | REFERENCE_IMPORT | invoke | selector-save-switch | Invoke | VERIFIED | PLANNING_LIST, CREATE_PLANNING_MODAL, CREATED_PROJECT, TEXT_READING, TEXT_EDITOR, TEXT_SAVED, EMPTY-文字, EMPTY-参考图, EMPTY-情绪板, EMPTY-镜头清单, EMPTY-灯光图, EMPTY-服化道, EMPTY-文件, REFERENCE_IMPORTED, 参考图, QUICK_PREVIEW, 情绪板, 灯光图, 服化道, MODULE-文字, MODULE-参考图, MODULE-情绪板, MODULE-镜头清单, MODULE-灯光图, MODULE-服化道, MODULE-文件, BOOKING_PICKER, EXPORT_DIALOG |
| import-open | REFERENCE_IMPORT | invoke | selector-import-open | Invoke | VERIFIED | EMPTY-参考图, EMPTY-情绪板, EMPTY-灯光图, EMPTY-服化道, REFERENCE_IMPORTED, 参考图, QUICK_PREVIEW, 情绪板, 灯光图, 服化道, MODULE-参考图, MODULE-情绪板, MODULE-灯光图, MODULE-服化道 |
| import-dialog | REFERENCE_IMPORT | waitPresent | selector-import-dialog |  | PLAN_BUG |  |
| import-file | REFERENCE_IMPORT | setValue | selector-import-file | Value | PLAN_BUG |  |
| import-submit | REFERENCE_IMPORT | invoke | selector-import-submit | Invoke | PLAN_BUG |  |
| reference-loaded | REFERENCE_ITEM | waitPresent | selector-reference-loaded | Invoke | VERIFIED | REFERENCE_IMPORTED, 参考图, MODULE-参考图 |
| quick-open | QUICK_PREVIEW | focusKey | selector-reference-loaded | Invoke | VERIFIED | REFERENCE_IMPORTED, 参考图, MODULE-参考图 |
| quick-landmark | QUICK_PREVIEW | assertPresent | selector-quick-landmark |  | VERIFIED | QUICK_PREVIEW |
| quick-shot | QUICK_PREVIEW | capture |  |  | NOT_APPLICABLE |  |
| quick-close | QUICK_PREVIEW | invoke | selector-quick-landmark | Invoke | VERIFIED | QUICK_PREVIEW |
| menu-open | CONTEXT_MENU | focusKey | selector-reference-loaded | Invoke | VERIFIED | REFERENCE_IMPORTED, 参考图, MODULE-参考图 |
| menu-item-0 | CONTEXT_MENU | assertPresent | selector-menu-item-0 |  | VERIFIED | CONTEXT_MENU, CONTEXT_MENU-参考图, CONTEXT_MENU-情绪板, CONTEXT_MENU-灯光图, CONTEXT_MENU-服化道 |
| menu-item-1 | CONTEXT_MENU | assertPresent | selector-menu-item-1 |  | VERIFIED | CONTEXT_MENU |
| menu-item-2 | CONTEXT_MENU | assertPresent | selector-menu-item-2 |  | VERIFIED | CONTEXT_MENU, CONTEXT_MENU-参考图, CONTEXT_MENU-情绪板, CONTEXT_MENU-灯光图, CONTEXT_MENU-服化道 |
| menu-item-3 | CONTEXT_MENU | assertPresent | selector-menu-item-3 |  | VERIFIED | CONTEXT_MENU, CONTEXT_MENU-参考图, CONTEXT_MENU-情绪板, CONTEXT_MENU-灯光图, CONTEXT_MENU-服化道 |
| menu-item-4 | CONTEXT_MENU | assertPresent | selector-menu-item-4 |  | VERIFIED | CONTEXT_MENU, CONTEXT_MENU-参考图, CONTEXT_MENU-情绪板, CONTEXT_MENU-灯光图, CONTEXT_MENU-服化道 |
| menu-item-5 | CONTEXT_MENU | assertPresent | selector-menu-item-5 |  | VERIFIED | CONTEXT_MENU, CONTEXT_MENU-参考图, CONTEXT_MENU-情绪板, CONTEXT_MENU-灯光图, CONTEXT_MENU-服化道 |
| menu-item-6 | CONTEXT_MENU | assertPresent | selector-menu-item-6 |  | VERIFIED | CONTEXT_MENU, CONTEXT_MENU-参考图, CONTEXT_MENU-情绪板, CONTEXT_MENU-灯光图, CONTEXT_MENU-服化道 |
| menu-shot | CONTEXT_MENU | capture |  |  | NOT_APPLICABLE |  |
| menu-escape | CONTEXT_MENU | focusKey | selector-menu-item-0 |  | VERIFIED | CONTEXT_MENU, CONTEXT_MENU-参考图, CONTEXT_MENU-情绪板, CONTEXT_MENU-灯光图, CONTEXT_MENU-服化道 |
| booking-open | BOOKING_PICKER | invoke | selector-booking-open | Invoke | VERIFIED | PLANNING_LIST, CREATE_PLANNING_MODAL, CREATED_PROJECT, TEXT_READING, TEXT_EDITOR, TEXT_SAVED, EMPTY-文字, EMPTY-参考图, EMPTY-情绪板, EMPTY-镜头清单, EMPTY-灯光图, EMPTY-服化道, EMPTY-文件, REFERENCE_IMPORTED, 参考图, QUICK_PREVIEW, 情绪板, 灯光图, 服化道, MODULE-文字, MODULE-参考图, MODULE-情绪板, MODULE-镜头清单, MODULE-灯光图, MODULE-服化道, MODULE-文件, BOOKING_PICKER, EXPORT_DIALOG |
| booking-landmark | BOOKING_PICKER | assertPresent | selector-booking-landmark |  | VERIFIED | BOOKING_PICKER |
| booking-shot | BOOKING_PICKER | capture |  |  | NOT_APPLICABLE |  |
| booking-close | BOOKING_PICKER | invoke | selector-booking-close | Invoke | VERIFIED | BOOKING_PICKER |
| export-open | PDF_EXPORT | invoke | selector-export-open | Invoke | VERIFIED | PLANNING_LIST, CREATE_PLANNING_MODAL, CREATED_PROJECT, TEXT_READING, TEXT_EDITOR, TEXT_SAVED, EMPTY-文字, EMPTY-参考图, EMPTY-情绪板, EMPTY-镜头清单, EMPTY-灯光图, EMPTY-服化道, EMPTY-文件, REFERENCE_IMPORTED, 参考图, QUICK_PREVIEW, 情绪板, 灯光图, 服化道, MODULE-文字, MODULE-参考图, MODULE-情绪板, MODULE-镜头清单, MODULE-灯光图, MODULE-服化道, MODULE-文件, BOOKING_PICKER, EXPORT_DIALOG |
| quality-expand | PDF_EXPORT | expand | selector-quality-expand | ExpandCollapse | VERIFIED | EXPORT_DIALOG |
| quality-select | PDF_EXPORT | select | selector-quality-select | SelectionItem | VERIFIED | EXPORT_QUALITY_POPUP |
| export-confirm | PDF_EXPORT | invoke | selector-export-confirm | Invoke | VERIFIED | EXPORT_DIALOG |
| save-dialog | PDF_EXPORT | waitPresent | selector-save-dialog |  | PLAN_BUG |  |
| save-path | PDF_EXPORT | setValue | selector-save-path | Value | PLAN_BUG |  |
| save-submit | PDF_EXPORT | invoke | selector-save-submit | Invoke | PLAN_BUG |  |
| export-message | PDF_EXPORT | assertPresent | selector-export-message |  | VERIFIED | EXPORT_MESSAGE |
| export-shot | PDF_EXPORT | capture |  |  | NOT_APPLICABLE |  |
| export-dismiss | PDF_EXPORT | invoke | selector-export-dismiss | Invoke | VERIFIED | EXPORT_MESSAGE |
| pdf-exists | PDF_EXPORT | assertFileSize |  |  | NOT_APPLICABLE |  |
| pdf-pages | PDF_EXPORT | assertPdfPages |  |  | NOT_APPLICABLE |  |
| shot-page | SHOT_LIST | invoke | selector-module-shots | Invoke | VERIFIED | PLANNING_LIST, CREATE_PLANNING_MODAL, CREATED_PROJECT, TEXT_READING, TEXT_EDITOR, TEXT_SAVED, EMPTY-文字, EMPTY-参考图, EMPTY-情绪板, EMPTY-镜头清单, EMPTY-灯光图, EMPTY-服化道, EMPTY-文件, REFERENCE_IMPORTED, 参考图, QUICK_PREVIEW, 情绪板, 灯光图, 服化道, MODULE-文字, MODULE-参考图, MODULE-情绪板, MODULE-镜头清单, MODULE-灯光图, MODULE-服化道, MODULE-文件, BOOKING_PICKER, EXPORT_DIALOG |
| shot-new | SHOT_LIST | invoke | selector-shot-new | Invoke | VERIFIED | EMPTY-镜头清单, MODULE-镜头清单 |
| more | TEXT_EDITOR | invoke | selector-more | Invoke | VERIFIED | PLANNING_LIST, CREATE_PLANNING_MODAL, CREATED_PROJECT, TEXT_READING, TEXT_EDITOR, TEXT_SAVED, EMPTY-文字, EMPTY-参考图, EMPTY-情绪板, EMPTY-镜头清单, EMPTY-灯光图, EMPTY-服化道, EMPTY-文件, REFERENCE_IMPORTED, 参考图, QUICK_PREVIEW, 情绪板, 灯光图, 服化道, MODULE-文字, MODULE-参考图, MODULE-情绪板, MODULE-镜头清单, MODULE-灯光图, MODULE-服化道, MODULE-文件, BOOKING_PICKER, EXPORT_DIALOG |
| shoot | TETHER | invoke | selector-shoot | Invoke | VERIFIED | MORE_MENU |
| tether-workspace | TETHER | assertPresent | selector-tether-workspace |  | VERIFIED | TETHER |
| tether-context | TETHER | assertEnabled | selector-tether-context |  | VERIFIED | TETHER |
| tether-shot-context | TETHER | assertPresent | selector-tether-shot-context |  | VERIFIED | TETHER |
| tether-shot | TETHER | capture |  |  | NOT_APPLICABLE |  |
| back-planning | PRIMARY_NAVIGATION | invoke | selector-planning-enabled | Invoke | VERIFIED | ONBOARDING, BOOT, TETHER, ONLINE_SELECTION |
| back-text | TEXT_EDITOR | invoke | selector-text-open | Invoke | VERIFIED | PLANNING_LIST, CREATE_PLANNING_MODAL, CREATED_PROJECT, TEXT_READING, TEXT_EDITOR, TEXT_SAVED, EMPTY-文字, EMPTY-参考图, EMPTY-情绪板, EMPTY-镜头清单, EMPTY-灯光图, EMPTY-服化道, EMPTY-文件, REFERENCE_IMPORTED, 参考图, QUICK_PREVIEW, 情绪板, 灯光图, 服化道, MODULE-文字, MODULE-参考图, MODULE-情绪板, MODULE-镜头清单, MODULE-灯光图, MODULE-服化道, MODULE-文件, BOOKING_PICKER, EXPORT_DIALOG |
| back-body | TEXT_EDITOR | assertPresent | selector-save-content |  | VERIFIED | TEXT_SAVED, EMPTY-文字, FRESH_PREVIEW, MODULE-文字, PREVIEW_MODE, BOOKING_PICKER, EXPORT_DIALOG, TETHER |
| online | ONLINE_SELECTION | invoke | selector-online | Invoke | VERIFIED | ONBOARDING, BOOT, TETHER, ONLINE_SELECTION |
| online-landmark | ONLINE_SELECTION | assertPresent | selector-online-landmark |  | VERIFIED | ONLINE_SELECTION |
| online-not-toolbox | ONLINE_SELECTION | assertAbsent | selector-preview-escape |  | VERIFIED | ONLINE_SELECTION |
| online-shot | ONLINE_SELECTION | capture |  |  | NOT_APPLICABLE |  |
| final-planning | PRIMARY_NAVIGATION | invoke | selector-planning-enabled | Invoke | VERIFIED | ONBOARDING, BOOT, TETHER, ONLINE_SELECTION |
