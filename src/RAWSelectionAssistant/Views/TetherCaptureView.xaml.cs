...
public partial class TetherCaptureView : UserControl
{
    ...
    private void ApplyResponsiveLayout(double windowWidth)
    {
        ...
        ThumbnailColumn.MaxWidth = _isBrowserCollapsed ? 0 : 280;
        ThumbnailColumn.Width = _isBrowserCollapsed ? new GridLength(0) : new GridLength(compact ? 220 : 236);
        ...
        InspectorColumn.MaxWidth = compact ? 0 : 320;
        InspectorColumn.Width = compact ? new GridLength(0) : new GridLength(296);
