...
public partial class MainWindow
{
        ...
        AssetLibraryP3AutomatedAcceptanceDriver driver)
    {
        ...
        {
            lifecycle_schema = "pixel-tart-p3-tag-manager-lifecycle/v2",
            group_create_command_changed_state = tag.GroupCreateCommandChangedState,
            group_rename_command_changed_state = tag.GroupRenameCommandChangedState,
            group_reorder_command_changed_state = tag.GroupReorderCommandChangedState,
            group_order_count = tag.GroupOrderCount,
            group_order_before_sha256 = tag.GroupOrderBeforeSha256,
            group_order_after_sha256 = tag.GroupOrderAfterSha256,
            tag_create_command_changed_state = tag.TagCreateCommandChangedState,
            tag_rename_command_changed_state = tag.RenameCommandChangedState,
            tag_reorder_command_changed_state = tag.TagReorderCommandChangedState,
            tag_order_count = tag.TagOrderCount,
            tag_order_before_sha256 = tag.TagOrderBeforeSha256,
            tag_order_after_sha256 = tag.TagOrderAfterSha256,
            tag_move_command_changed_state = tag.TagMoveCommandChangedState,
            tag_original_group_id = tag.TagOriginalGroupId,
            tag_moved_group_id = tag.TagMovedGroupId,
            tag_archive_command_changed_state = tag.TagArchiveCommandChangedState,
            tag_restore_command_changed_state = tag.TagRestoreCommandChangedState,
            archive_restore_preserved_memberships = tag.ArchiveRestorePreservedMemberships,
            merge_source_membership_count_before = tag.MergeSourceMembershipCountBefore,
            merge_target_membership_count_before = tag.MergeTargetMembershipCountBefore,
            merge_overlap_count_before = tag.MergeOverlapCountBefore,
            merge_source_membership_count_after = tag.MergeSourceMembershipCountAfter,
            merge_target_membership_count_after = tag.MergeTargetMembershipCountAfter,
            merge_duplicate_membership_count = tag.MergeDuplicateMembershipCount,
            merge_source_archived = tag.MergeSourceArchived,
            merge_memberships_deduplicated = tag.MergeMembershipsDeduplicated,
            group_cycle_rejected = tag.GroupCycleRejected,
            group_hierarchy_model = "flat-no-parent-reference",
            group_cycle_proof = "public-flat-group-order-and-tag-reference-contract",
