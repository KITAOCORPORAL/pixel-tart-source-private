...
public sealed record VisualSimilarityDiagnostics(
    int CandidateRows,
    double PruningMilliseconds,
    double ExactScoringMilliseconds,
    double TotalMilliseconds,
    int ReturnedRows);

public interface IVisualAssetQueryDiagnosticsProvider
{
    VisualSimilarityDiagnostics? LastSimilarityDiagnostics { get; }
}
