...
public static class ToolRegistry
{
    ...
    [
        ...
        new(ToolId.ReferenceColor, "参考仿色", "借用参考图片的影调与色彩，建立可重复使用的色彩方案。", "ToolIconReferenceColor", "ReferenceColor", true, true, FeatureAvailability.Production, ToolMenuGroup.Output, 57),
