...
$python='C:\Users\Administrator\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe';$sheet=Join-Path $OutputRoot (Decode '5YOP57Sg6JuL5oyeXzIuMy4w6Zi25q61ReacgOe7iFVJ6aqM5pS25oC76KeILnBuZw==');& $python (Join-Path $PSScriptRoot 'create_contact_sheet.py') --input $OutputRoot --output $sheet;if($LASTEXITCODE-ne 0){throw 'Stage E contact sheet failed.'}
