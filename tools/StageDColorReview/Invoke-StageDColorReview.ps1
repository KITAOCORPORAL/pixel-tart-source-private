...
$python='C:\Users\Administrator\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe';$sheetName="$([char]0x50CF)$([char]0x7D20)$([char]0x86CB)$([char]0x631E)_2.3.0$([char]0x9636)$([char]0x6BB5)D_LUT$([char]0x4E0E)$([char]0x5BA2)$([char]0x6237)$([char]0x76D1)$([char]0x770B)UI$([char]0x603B)$([char]0x89C8).png";$sheet=Join-Path $OutputRoot $sheetName;& $python (Join-Path $PSScriptRoot 'create_contact_sheet.py') --input $OutputRoot --output $sheet;if($LASTEXITCODE-ne 0){throw 'Stage D contact sheet failed.'}
