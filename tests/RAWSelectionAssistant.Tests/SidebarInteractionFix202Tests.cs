...
public sealed class SidebarInteractionFix202Tests
{
    ...
    [TestMethod] public void Requirement44_AllPrimaryEntries_UseStableTemplate() { var sidebar = SidebarSlice(); foreach (var name in new[] { "工作台", "本地分片", "归片工作区", "项目历史", "授权与版本", "设置", "帮助" }) Contains(sidebar, $"Content=\"{name}\""); Assert.IsGreaterThanOrEqualTo(Count(sidebar, "SidebarNavButton"), 11); }
    [TestMethod] public void Requirement45_AllFooterEntries_UseDedicatedRows() => Contains(SidebarSlice(), "Grid.Row=\"2\"", "Grid.Row=\"3\"", "Grid.Row=\"4\"", "Content=\"工具箱\"", "Content=\"使用教程\"", "Content=\"问题反馈\"", "IconExpand", "展开侧栏");
