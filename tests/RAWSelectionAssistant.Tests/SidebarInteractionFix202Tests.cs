...
public sealed class SidebarInteractionFix202Tests
{
    ...
    [TestMethod] public void Requirement45_AllFooterEntries_UseDedicatedRows() => Contains(SidebarSlice(), "Grid.Row=\"2\"", "Grid.Row=\"3\"", "Grid.Row=\"4\"", "ToolboxEntry.DisplayName", "Content=\"使用教程\"", "Content=\"问题反馈\"", "IconPanelExpand", "展开侧栏");
    ...
    [TestMethod] public void Requirement47_AllEntries_HaveTooltipsAndAutomationNames() { var sidebar = SidebarSlice(); Assert.IsGreaterThanOrEqualTo(14, Count(sidebar, "ToolTip=")); Assert.IsGreaterThanOrEqualTo(14, Count(sidebar, "AutomationProperties.Name=")); }
