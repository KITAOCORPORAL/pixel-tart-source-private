...
public sealed class WorkbenchEnhancement203Tests
{
    ...
    [TestMethod] public void AppIs230AndUnpublishedInstallerRemains220() { Contains(Text("src/RAWSelectionAssistant.Core/Models/Branding.cs"), "2.3.0"); Contains(Text("installer/RAWSelectionAssistant.iss"), "MyAppVersion \"2.2.0\"", "像素蛋挞_Setup_2.2.0_x64"); }
