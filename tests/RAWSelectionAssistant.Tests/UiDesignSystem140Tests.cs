...
public sealed class UiDesignSystem140Tests
{
    ...
    [TestMethod] public void HelpDialog_ShowsVersion203() => Contains("src/RAWSelectionAssistant/Views/HelpWindow.xaml", "版本 2.0.3", "DynamicResource WindowBackgroundBrush");
    ...
    [TestMethod] public void Version_BrandingSourceIs203() => Contains("src/RAWSelectionAssistant.Core/Models/Branding.cs", "ProductVersion = \"2.0.3\"");
    [TestMethod] public void Version_InstallerOutputs203Package() => Contains("installer/RAWSelectionAssistant.iss", "MyAppVersion \"2.0.3\"", "像素蛋挞_Setup_2.0.3_x64");
