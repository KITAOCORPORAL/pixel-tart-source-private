...
public sealed class UiDesignSystem140Tests
{
    ...
    [TestMethod] public void HelpDialog_ShowsVersion210() => Contains("src/RAWSelectionAssistant/Views/HelpWindow.xaml", "版本 2.1.0", "DynamicResource WindowBackgroundBrush");
    ...
    [TestMethod] public void Version_BrandingSourceIs210() => Contains("src/RAWSelectionAssistant.Core/Models/Branding.cs", "ProductVersion = \"2.1.0\"");
    [TestMethod] public void Version_InstallerOutputs210Package() => Contains("installer/RAWSelectionAssistant.iss", "MyAppVersion \"2.1.0\"", "像素蛋挞_Setup_2.1.0_x64");
