...
public sealed class WorkbenchVisualCorrection201Tests
{
    ...
    [TestMethod] public void WorkbenchDefaultDarkResources_AreComplete() => Contains(Dark(), "#0D0F12", "#121519", "#171B20", "#1D2228", "#222830", "#292F37", "#D79A32", "#18A88C");
    ...
    [TestMethod] public void Sidebar_IsCompactAndGrouped() { Contains(MainXaml(), "Text=\"工作\" Style=\"{StaticResource SidebarSectionLabel}\"", "Text=\"工具\" Style=\"{StaticResource SidebarSectionLabel}\"", "Text=\"系统\" Style=\"{StaticResource SidebarSectionLabel}\"", "ToolboxEntry.DisplayName", "Content=\"帮助\""); var source = MainXaml(); var start = source.IndexOf("x:Name=\"SidebarContainer\"", StringComparison.Ordinal); var end = source.IndexOf("x:Name=\"WorkbenchShell\"", start, StringComparison.Ordinal); DoesNotContain(source[start..end], "Content=\"使用教程\"", "Content=\"问题反馈\""); Contains(source, "Content=\"打开帮助与教程\"", "Content=\"建议与问题反馈\""); }
