...
public sealed class Version230Rc2CalendarTetherTests
{
    ...
    public void CompactCalendarSupportsMouseKeyboardContextAndVisibleMarkers()
    {
        ...
        foreach (var token in new[] { "DayCell_MouseLeftButtonDown", "DayCell_PreviewKeyDown", "CreateBooking_Click", "BookingCountBadgeText", "PrimaryWorkflowStatus", "ConflictGlyph", "WeatherGlyph" })
